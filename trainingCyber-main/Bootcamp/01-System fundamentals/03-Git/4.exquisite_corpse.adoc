...
Duration: *1 day* +
Team challenge: *4* (https://docs.google.com/spreadsheets/d/1RqvJ40tacjpQAtYB-n6QZc1HsFU3LgOZYAG534GlGLY/edit?usp=sharing[Groups])
...
image::https://www.nobledesktop.com/image/gitresources/git-branches-merge.png[branch]
