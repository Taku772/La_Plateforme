...
* Finally, once the group is aligned on all issues, but also on the regulation and context, prepare a management summary to condense all the information discussed. Please note that this document should be simple BUT should always contain the necessary annexes and sources. (not included in deadline)
